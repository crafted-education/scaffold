...
Column.prototype.getMinWidth = function() {
	...
	var max = this._sizingMgr.getMinSize();
...
Column.prototype.removeChildCell = function(cell) {
	//Need to check to make sure the column hasn't been deleted
...
Column.name = 'Column'; //IE doesn't support implicit name on function yet
